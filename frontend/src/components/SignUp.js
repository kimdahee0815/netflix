...
export default function SignUp({ openSignUp, signUpOpen, signUpClose }) {
    ...
    const handleIdChange = (event) => {
        ...
        setIdError(isValidId(event.target.value) ? "" : "Please enter a valid email address.");
                ...
                <Fade in={open}>
                    <Box sx={style}>
                        ...
                        >
                            ...
                            <FormHelperText sx={{ padding: "1px", color: "red" }}>{idError}</FormHelperText>
                        </Box>
                        ...
                        <Box sx={inputFormStyle} style={{ alignItems: "center" }}>
                            <Typography sx={{ width: "150px", mr: 5 }} variant="h10" component="h4">
                                Security Answer
                            </Typography>
                        ...
                        <Box sx={{ mx: "auto", width: 100, marginTop: "15px" }}>
                            <CustomizedButton label="Sign Up" onClick={loginSubmit}></CustomizedButton>
                        </Box>
                    </Box>
                </Fade>
            </Modal>
